...
export class InmuebleSolicitudController {
  ...
  async find(
    ...
    return this.inmuebleRepository.inmuebletienesolicitudes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.inmuebletienesolicitudes(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.inmuebletienesolicitudes(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.inmuebletienesolicitudes(id).delete(where);
  }
}

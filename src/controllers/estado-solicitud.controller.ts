...
export class EstadoSolicitudController {
  ...
  async find(
    ...
    return this.estadoRepository.estadotienesolicitudes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.estadoRepository.estadotienesolicitudes(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.estadoRepository.estadotienesolicitudes(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.estadoRepository.estadotienesolicitudes(id).delete(where);
  }
}
